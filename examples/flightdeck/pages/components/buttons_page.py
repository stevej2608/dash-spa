            ...
            html.Div([
                html.Div([
                    ...
                    html.Button([
                        ...
                        ], className='icon icon-xxs me-2', viewBox='0 0 24 24', xmlns='http://www.w3.org/2000/svg'),
                        "Contact Us"
                    ], className='btn btn-primary d-inline-flex align-items-center', type='button'),
                    ...
                    html.Div([
                        html.H2("Link Buttons", className='h5')
                    ], className='mb-3 mt-5'),
                    ...
                    html.Div([
                        html.H2("Choose your color", className='h5')
                    ], className='mb-3 mt-5'),
                    html.Div([
                    ...
                    html.Div([
                        html.Small("Outline", className='text-uppercase fw-bold')
                    ], className='mb-3 mt-5'),
                    ...
                    html.Div([
                        html.Small("Round Outline", className='text-uppercase fw-bold')
                    ], className='mb-3 mt-5'),
                    ...
                    html.Div([
                        html.Small("Links", className='text-uppercase fw-bold')
                    ], className='mb-3 mt-5'),
                    ...
                    html.Div([
                        html.Div([
                            html.Div([
                                html.H2("Social Buttons", className='h5 fw-bold')
                            ], className='mb-4 mt-5'),
                            html.Button([
                                Svg([
                        ...
                        html.Div([
                            html.Div([
                                html.H2("Only Icon", className='h5')
                            ], className='mb-4 mt-5'),
                            html.Button([
                                Svg([
                                    Path(d='M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z', fill='currentColor')
